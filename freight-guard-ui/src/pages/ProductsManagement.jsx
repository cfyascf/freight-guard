                ...
                <div className="space-y-8 max-w-md">
                  ...
                  <div className="space-y-4 border-t border-slate-100 pt-6">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <button disabled={!isEditing} onClick={() => handleUpdateField("empilhavel", !activeProduct.empilhavel)} className={`flex w-full items-start gap-3 rounded-xl border border-slate-200 bg-white p-4 text-left transition-colors focus:outline-none disabled:cursor-not-allowed disabled:opacity-80 ${isEditing && "hover:border-slate-300"}`}>
                        <div className={`mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded border ${activeProduct.empilhavel ? "border-blue-600 bg-blue-600" : "border-slate-300"}`}>
