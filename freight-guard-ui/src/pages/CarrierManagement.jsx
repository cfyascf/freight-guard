...
export default function CarrierDashboard() {
  ...
  const financialMetrics = {
    dailyRevenue: 14500.0,
    monthlyRevenue: 245000.0,
    pendingPayments: 32000.0,
  }
    ...
    <AppShell title="Dashboard Operacional (Transportadora)">
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-slate-800">
              {formatCurrency(financialMetrics.dailyRevenue)}
            </div>
        ...
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-slate-500">
              {fleetMetrics.inTransit} de {fleetMetrics.totalVehicles} veículos
              rodando
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-slate-800">
              {fleetMetrics.available}
            </div>
            <p className="mt-1 text-xs text-slate-500">Prontos para alocação</p>
          </CardContent>
        </Card>

        <Card className="relative overflow-hidden border-red-100 shadow-sm">
          <div className="absolute top-0 right-0 -z-10 h-16 w-16 rounded-bl-full bg-red-50"></div>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-slate-500">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              {activeTransportsMock.map((transport) => (
                ...
                >
                  ...
                  <div className="hidden w-32 flex-col md:flex">
                    <div className="mb-1.5 flex justify-between text-[10px] font-semibold text-slate-500 uppercase">
                      <span>Progresso</span>
        ...
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent className="space-y-4 pt-4">
            <Button
              asChild
              className="w-full justify-start border-none bg-blue-50 text-blue-700 shadow-none hover:bg-blue-100"
            >
            ...
            <Button
              asChild
              className="w-full justify-start border border-slate-200 bg-slate-50 text-slate-700 shadow-none hover:bg-slate-100"
            >
              <Link to="/transport-overview">
            ...
            <div className="mt-6 border-t border-slate-100 pt-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <CheckCircle2
                    size={16}
                    className="mt-0.5 mr-2 text-emerald-500"
                  />
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Veículo ABC-1234 passou no validador de volume.
                    </p>
                  </div>
                </div>
              </div>
